...
[data-testid="stMetric"] {
    background: linear-gradient(180deg, #D6E9F8 0%, #C3DEF5 100%);
...
hr { border-color: #B9D9F2 !important; }
...
def render_stock_card(
    ...
    if not hist.empty:
        ...
        fig.update_layout(
            ...
            xaxis=dict(gridcolor="#B9D9F2", showgrid=False),
            yaxis=dict(gridcolor="#B9D9F2"),
            showlegend=False,
        )
    ...
    with tab_charts:
        ...
        if not bench.empty:
            ...
            fig3.update_layout(
                ...
                xaxis=dict(gridcolor="#B9D9F2"), yaxis=dict(gridcolor="#B9D9F2"),
            )
